...
-- 2017-01-01,ALaureano,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_ALaureano')
	 Begin 
	  Alter Database [Assignment07DB_ALaureano] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_ALaureano;
	 End
	Create Database Assignment07DB_ALaureano;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_ALaureano;
